  ...
  return (
    <div className="auth-page">
      ...
      <style>{`
        ...
        .auth-logo-text{font-family:'Syne',sans-serif;font-size:1.3rem;letter-spacing:.12em;color:#F8F9FB}
        .auth-title{font-family:'Inter',sans-serif;font-size:1.3rem;font-weight:700;color:#F8F9FB;text-align:center;margin-bottom:6px}
        ...
        .auth-label{font-family:'Inter',sans-serif;font-size:0.6rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:#7A8EA8}
        .auth-inp{background:rgba(7,15,31,0.6);border:1px solid rgba(249,115,22,0.18);border-radius:6px;padding:10px 13px;font-size:14px;color:#F8F9FB;font-family:'Inter',sans-serif;outline:none;transition:border-color 0.2s;width:100%}
        .auth-inp:focus{border-color:#F97316;box-shadow:0 0 0 3px rgba(249,115,22,0.1)}
        .auth-inp::placeholder{color:#7A8EA8}
        .auth-btn-primary{width:100%;padding:12px 0;background:#F97316;color:#0B2447;border:none;border-radius:6px;font-family:'Inter',sans-serif;font-weight:700;font-size:0.8rem;letter-spacing:.1em;text-transform:uppercase;cursor:pointer;transition:all 0.2s}
