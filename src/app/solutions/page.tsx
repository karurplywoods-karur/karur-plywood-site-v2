    ...
    <div style={{ background: '#FAF8F5', paddingTop: 58, minHeight: '100vh' }}>
      ...
      <section className="sol-hero">
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 48px', position: 'relative', zIndex: 2 }} className="sol-pad">
          ...
          <h1 style={{ fontFamily: "'Inter',sans-serif", fontSize: 'clamp(1.8rem,3.6vw,2.6rem)', fontWeight: 700, color: '#FFFFFF', lineHeight: 1.1, marginBottom: 14, maxWidth: 500 }}>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '36px 48px 60px' }} className="sol-pad">
        <div className="sol-layout">
          <div>
            <h2 style={{ fontFamily: "'Inter',sans-serif", fontSize: '1.3rem', fontWeight: 700, color: '#0B2447', marginBottom: 20 }}>Explore Solutions</h2>
              ...
              {SOLUTIONS.map(s => (
                <Link key={s.key} href={s.href} className="sol-card">
                  ...
                  <div style={{ padding: '14px 16px 18px' }}>
                    <div style={{ fontFamily: "'Inter',sans-serif", fontWeight: 700, fontSize: 14, color: '#0B2447', marginBottom: 6 }}>{s.t}</div>
                    <div style={{ fontSize: 12.5, color: '#6B7280', lineHeight: 1.5, marginBottom: 10 }}>{s.d}</div>
                    <span style={{ fontSize: 12, color: '#F07316', fontWeight: 700, fontFamily: "'Inter',sans-serif" }}>Explore →</span>
                  </div>
                </Link>
              ))}
            </div>
          ...
          <aside>
            <div className="sol-sb-card" style={{ marginBottom: 16 }}>
              <div style={{ fontFamily: "'Inter',sans-serif", fontWeight: 700, fontSize: 13, color: '#0B2447', marginBottom: 12 }}>Why Choose Our Solutions?</div>
            ...
            <div className="sol-custom-card" style={{ marginBottom: 16 }}>
              <div style={{ fontFamily: "'Inter',sans-serif", fontWeight: 700, fontSize: 14, color: '#0B2447', marginBottom: 6 }}>Need a Custom Solution?</div>
            ...
            <div className="sol-bom-card">
              <div style={{ fontFamily: "'Inter',sans-serif", fontWeight: 700, fontSize: 14, color: '#0B2447', marginBottom: 6 }}>Have a Project in Mind?</div>
        ...
        <div className="sol-stats">
          {[
            ...
            <div key={l} style={{ textAlign: 'center' }}>
              <div style={{ fontFamily: "'Syne',sans-serif", fontSize: '1.6rem', color: '#0B2447' }}>{n}</div>
      ...
      <style>{`
        ...
        .sol-highlight { display: flex; align-items: center; gap: 6px; font-size: 12px; color: #FFFFFF; font-family: 'Inter',sans-serif; font-weight: 600; }
        ...
        .sol-btn-primary { display: inline-flex; align-items: center; padding: 9px 16px; background: #16a34a; color: #FFFFFF; border-radius: 6px; font-family: 'Inter',sans-serif; font-weight: 700; font-size: 12px; text-decoration: none; }
        .sol-btn-outline { display: inline-flex; align-items: center; padding: 9px 16px; border: 1px solid #E5E1DC; color: #0B2447; border-radius: 6px; font-family: 'Inter',sans-serif; font-weight: 700; font-size: 12px; text-decoration: none; background: #FFFFFF; }
