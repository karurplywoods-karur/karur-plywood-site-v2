...
export const metadata: Metadata = { title: 'About Us | Karur Plywood & Company â€” 25+ Years of Trust', description: "Learn about Karur Plywood & Company â€” Karur's leading plywood dealer with 25+ years of experience. Family-owned, customer-first." };
      ...
      <section style={{ background:'linear-gradient(135deg,#1C140D,#161009)',borderBottom:'1px solid rgba(200,136,74,0.15)',padding:'80px 0' }}>
        <div style={{ maxWidth:1200,margin:'0 auto',padding:'0 48px',display:'grid',gridTemplateColumns:'1fr 1fr',gap:80,alignItems:'center' }} className="about-hero">
          <div>
            ...
            <p style={{ fontSize:15,color:'#9A8070',lineHeight:1.85,marginBottom:14 }}>Karur Plywood and Company was founded with one simple belief â€” that quality building materials, sold at honest prices, can transform homes and livelihoods. Starting as a small retail shop in Karur, we have grown into one of the region's most trusted wholesale and retail suppliers.</p>
            <p style={{ fontSize:15,color:'#9A8070',lineHeight:1.85,marginBottom:14 }}>Today, we serve hundreds of contractors, carpenters, builders and homeowners across Karur, Trichy, Namakkal and the surrounding districts. Our experienced team helps every customer â€” from a first-time homebuilder to a seasoned contractor â€” choose exactly the right product.</p>
            ...
            <div style={{ display:'flex',gap:14,flexWrap:'wrap' }}>
              <a href={`https://wa.me/${WA}?text=Hi%2C+I+want+to+know+more+about+your+shop.`} target="_blank" rel="noopener" style={{ display:'inline-flex',alignItems:'center',gap:8,padding:'13px 24px',borderRadius:8,background:'#25D366',color:'white',fontWeight:700,fontSize:14,textDecoration:'none' }}>ðŸ’¬ Chat With Us</a>
              <Link href="/products" style={{ display:'inline-flex',alignItems:'center',gap:8,padding:'13px 24px',borderRadius:8,background:'transparent',color:'#F0E8DC',fontWeight:600,fontSize:14,textDecoration:'none',border:'1px solid rgba(200,136,74,0.3)' }}>View Our Products â†’</Link>
            </div>
          </div>
        ...
        <div style={{ maxWidth:1200,margin:'0 auto',padding:'0 48px' }}>
          ...
          <div style={{ marginTop:72 }}>
            ...
            <div style={{ display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:20 }} className="values-grid">
              {[['ðŸŽ¯','Quality First','We stock only ISI-marked, BIS-certified products from nationally trusted brands. No compromise.'],['ðŸ¤','Honest Pricing','Transparent pricing for both retail and wholesale. No hidden charges or inflated rates.'],['ðŸ’¡','Expert Guidance','Our team helps you pick the right product for your specific use case.'],['ðŸŒ±','Community First','Proud to be a Karur-based business serving local builders, carpenters and families.']].map(([i,t,d]) => (
