    ...
    <div style={{ minHeight: '100vh', background: '#0E0B08', color: '#F0E8DC', fontFamily: 'Outfit,sans-serif' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '28px 28px' }}>
        ...
        <div style={{ display: 'flex', gap: 4, marginBottom: 24, background: '#1C140D', border: '1px solid rgba(200,136,74,0.15)', borderRadius: 12, padding: 5, width: 'fit-content', flexWrap: 'wrap' }}>
          ...
          <a href="/admin/fulfillment" style={{ padding: '9px 20px', borderRadius: 8, fontFamily: 'Outfit,sans-serif', fontWeight: 600, fontSize: 13, background: 'transparent', color: '#9A8070', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>🚚 Fulfillment ↗</a>
          <a href="/admin/product-images" style={{ padding: '9px 20px', borderRadius: 8, fontFamily: 'Outfit,sans-serif', fontWeight: 600, fontSize: 13, background: 'transparent', color: '#9A8070', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>🖼️ Images ↗</a>
