    ...
    <div style={{ background: '#FAF8F5', paddingTop: 58 }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '24px 48px 60px' }} className="post-pad">
        ...
        <div className="post-layout">
          <article>
            <div style={{ fontFamily: "'Inter',sans-serif", fontSize: 10.5, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: '#F07316', marginBottom: 12 }}>{post.category}</div>
            <h1 style={{ fontFamily: "'Inter',sans-serif", fontSize: 'clamp(1.5rem,3vw,2rem)', fontWeight: 700, color: '#0B2447', lineHeight: 1.2, marginBottom: 14 }}>{post.title}</h1>
            ...
            <div style={{ marginTop: 32, background: '#0B2447', borderRadius: 12, padding: '24px 28px' }}>
              <div style={{ fontFamily: "'Inter',sans-serif", fontSize: 18, fontWeight: 700, color: '#FFFFFF', marginBottom: 6 }}>Still Have Questions?</div>
          ...
          <aside>
            ...
            <div className="post-expert-card">
              <div style={{ fontFamily: "'Inter',sans-serif", fontWeight: 700, fontSize: 14, color: '#FFFFFF', marginBottom: 4 }}>Need Help Choosing?</div>
      ...
      <style>{`
        .blog-content h2{font-family:'Inter',sans-serif;font-size:1.35rem;font-weight:700;color:#0B2447;margin:32px 0 14px;line-height:1.25}
        .blog-content h3{font-family:'Inter',sans-serif;font-size:1.1rem;font-weight:700;color:#F07316;margin:24px 0 10px}
        ...
        .post-expert-btn { display: inline-flex; align-items: center; padding: 10px 18px; background: #F07316; color: #FFFFFF; border-radius: 6px; font-family: 'Inter',sans-serif; font-weight: 700; font-size: 12px; text-decoration: none; }
