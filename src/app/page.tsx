  ...
  return (
    <main>
        ...
        <div className="container stats-strip-inner">
          {[
            ...
            <div key={s.t} className="stat-item">
              ...
              <div>
                <div className="stat-item-num" style={{ fontFamily: "'Inter',sans-serif", fontSize: '0.82rem', fontWeight: 700 }}>{s.t}</div>
      ...
      <style>{`
        ...
        .eyebrow { font-family: 'Inter', sans-serif; font-size: 0.62rem; font-weight: 700; letter-spacing: 0.25em; text-transform: uppercase; color: #F07316; margin-bottom: 10px; display: flex; align-items: center; justify-content: center; gap: 8px; }
        .eyebrow::before, .eyebrow::after { content: ''; width: 20px; height: 1px; background: #F07316; }
        .section-title { font-family: 'Syne', sans-serif; font-size: clamp(2rem, 4vw, 3rem); letter-spacing: 0.04em; color: #0B2447; line-height: 0.95; margin-bottom: 16px; }
        ...
        .eyebrow-pill { display: inline-flex; align-items: center; gap: 8px; background: rgba(249,115,22,0.12); border: 1px solid rgba(249,115,22,0.3); border-radius: 100px; padding: 5px 16px; font-family: 'Inter', sans-serif; font-size: 0.68rem; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: #FF9A45; margin-bottom: 24px; }
        ...
        .cta-outline-light { display: inline-flex; align-items: center; padding: 14px 28px; border: 1.5px solid rgba(255,255,255,0.55); color: #FFFFFF; border-radius: 6px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.78rem; letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; transition: all 0.2s; }
        ...
        .cta-outline { display: inline-flex; align-items: center; padding: 13px 24px; border: 1px solid rgba(240,115,22,0.4); color: #F07316; border-radius: 6px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.78rem; letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; transition: all 0.2s; }
        .cta-outline:hover { background: rgba(240,115,22,0.08); border-color: #F07316; }
        .cta-outline-orange { display: inline-flex; align-items: center; padding: 12px 28px; border: 2px solid #F07316; color: #F07316; border-radius: 6px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.78rem; letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; transition: all 0.2s; }
        .cta-outline-orange:hover { background: #F07316; color: #FFFFFF; }
        .hero-trust { display: flex; gap: 10px; flex-wrap: wrap; }
        .trust-chip { display: flex; align-items: center; gap: 6px; font-family: 'Inter', sans-serif; font-size: 0.62rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: #E5E1DC; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.16); border-radius: 3px; padding: 5px 10px; }
        ...
        .stat-item-num { font-family: 'Space Grotesk', sans-serif; font-size: 1.7rem; letter-spacing: 0.03em; color: #0B2447; line-height: 1; }
        .stat-item-lbl { font-family: 'Inter', sans-serif; font-size: 0.68rem; font-weight: 600; letter-spacing: 0.06em; color: #6B7280; margin-top: 3px; }
        ...
        .section-title-left { font-family: 'Syne', sans-serif; font-size: clamp(1.5rem, 2.6vw, 2rem); letter-spacing: 0.04em; color: #0B2447; }
        .section-view-all { font-family: 'Inter', sans-serif; font-size: 0.72rem; font-weight: 700; letter-spacing: 0.06em; color: #F07316; text-decoration: none; white-space: nowrap; }
        ...
        .about-title { font-family: 'Syne', sans-serif; font-size: clamp(1.8rem, 3.4vw, 2.6rem); letter-spacing: 0.02em; color: #0B2447; line-height: 1.1; margin: 10px 0 16px; }
        ...
        .about-stat-num { font-family: 'Space Grotesk', sans-serif; font-size: 1.7rem; color: #0B2447; letter-spacing: 0.02em; }
        .about-stat-lbl { font-size: 0.68rem; color: #6B7280; font-family: 'Inter', sans-serif; font-weight: 600; margin-top: 2px; }
        .cta-solid-navy { display: inline-flex; align-items: center; padding: 13px 26px; background: #0B2447; color: #FFFFFF; border-radius: 6px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.76rem; letter-spacing: 0.08em; text-transform: uppercase; text-decoration: none; transition: all 0.2s; }
        ...
        .about-badge-num { font-family: 'Space Grotesk', sans-serif; font-size: 1.1rem; color: #FFFFFF; line-height: 1; }
        .about-badge-lbl { font-size: 0.6rem; color: #C7D2E0; font-family: 'Inter', sans-serif; text-transform: uppercase; letter-spacing: 0.06em; }
        ...
        .why-dark-title { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.85rem; color: #FFFFFF; margin-bottom: 6px; }
        ...
        .blog-card-title { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.82rem; color: #0B2447; line-height: 1.4; margin-bottom: 8px; }
        ...
        .prod-cat-badge { position: absolute; top: 8px; left: 8px; background: #FFFFFF; border: 1px solid rgba(240,115,22,0.3); border-radius: 3px; padding: 2px 8px; font-family: 'Inter', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: #F07316; }
        .prod-body { padding: 16px 18px 18px; flex: 1; display: flex; flex-direction: column; }
        .prod-name { font-family: 'Inter', sans-serif; font-size: 0.88rem; font-weight: 700; color: #0B2447; line-height: 1.35; margin-bottom: 6px; }
        ...
        .prod-price { font-family: 'Space Grotesk', sans-serif; font-size: 1.5rem; color: #F07316; letter-spacing: 0.03em; }
        .prod-unit { font-size: 0.68rem; color: #6B7280; }
        .prod-wa-btn { display: flex; align-items: center; justify-content: center; gap: 6px; padding: 9px 0; border-radius: 5px; background: #25D366; color: white; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.68rem; letter-spacing: 0.08em; text-transform: uppercase; text-decoration: none; transition: background 0.2s; }
        ...
        .how-mode-title { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.9rem; color: #0B2447; margin-bottom: 3px; }
        ...
        .how-step-num { font-family: 'Space Grotesk', sans-serif; font-size: 2.5rem; letter-spacing: 0.04em; color: rgba(240,115,22,0.25); line-height: 1; flex-shrink: 0; width: 52px; }
        .how-step-title { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.92rem; color: #0B2447; margin-bottom: 4px; }
        ...
        .why-title { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.92rem; color: #0B2447; margin-bottom: 8px; }
        ...
        .review-avatar { width: 38px; height: 38px; border-radius: 50%; background: linear-gradient(135deg, #F07316, #FF9A45); display: flex; align-items: center; justify-content: center; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 16px; color: #FFFFFF; flex-shrink: 0; }
        .review-name { font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.85rem; color: #0B2447; }
        ...
        .faq-q { padding: 16px 20px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.88rem; color: #0B2447; cursor: pointer; list-style: none; display: flex; justify-content: space-between; align-items: center; }
        ...
        .cta-banner-title { font-family: 'Syne', sans-serif; font-size: clamp(2rem, 3.6vw, 3rem); letter-spacing: 0.03em; color: #FFFFFF; line-height: 1.05; margin-bottom: 14px; }
        ...
        .cta-call-lg { display: inline-flex; align-items: center; padding: 14px 28px; background: rgba(240,115,22,0.1); border: 1px solid rgba(240,115,22,0.35); color: #F07316; border-radius: 6px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.85rem; letter-spacing: 0.06em; text-decoration: none; transition: all 0.2s; }
        .cta-call-lg:hover { background: rgba(240,115,22,0.18); }
        .cta-location-link { font-size: 0.75rem; font-family: 'Inter', sans-serif; font-weight: 700; letter-spacing: 0.08em; color: #A8BCCC; text-decoration: none; transition: color 0.2s; }
