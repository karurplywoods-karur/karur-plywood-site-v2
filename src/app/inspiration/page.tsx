    ...
    <div style={{ background: '#FAF8F5', paddingTop: 58, minHeight: '100vh' }}>
      ...
      <section className="insp-hero">
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 48px', position: 'relative', zIndex: 2 }} className="insp-pad">
          ...
          <h1 style={{ fontFamily: "'Syne',sans-serif", fontSize: 'clamp(1.8rem,3.6vw,2.6rem)', fontWeight: 700, color: '#FFFFFF', lineHeight: 1.1, marginBottom: 14, maxWidth: 480 }}>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '28px 48px 60px' }} className="insp-pad">
        ...
        {items.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '70px 0', background: '#FFFFFF', border: '1px solid #E5E1DC', borderRadius: 12, marginTop: 20 }}>
            ...
            <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 700, color: '#0B2447', marginBottom: 8, fontSize: 17 }}>
            ...
            {items.map((it: any) => (
              <Link key={it.id} href={`/inspiration/${it.slug}`} className="insp-card">
                ...
                <div style={{ padding: '14px 16px 16px' }}>
                  <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 700, fontSize: 13.5, color: '#0B2447', marginBottom: 8 }}>{it.title}</div>
      ...
      <style>{`
        ...
        .insp-tab { padding: 10px 14px; font-family: 'Syne',sans-serif; font-size: 0.72rem; font-weight: 700; color: #6B7280; text-decoration: none; white-space: nowrap; border-bottom: 2px solid transparent; }
        ...
        .insp-card-tag { position: absolute; top: 10px; left: 10px; background: rgba(11,36,71,0.85); color: #FFFFFF; font-family: 'Syne',sans-serif; font-size: 9.5px; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; padding: 3px 9px; border-radius: 3px; }
        .insp-btn-wa { display: inline-flex; align-items: center; padding: 11px 22px; background: #f0fdf4; border: 1px solid #bbf7d0; color: #16a34a; border-radius: 6px; font-family: 'Syne',sans-serif; font-weight: 700; font-size: 13px; text-decoration: none; }
