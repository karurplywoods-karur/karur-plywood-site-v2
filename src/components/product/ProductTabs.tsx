  ...
  return (
    <div>
      ...
      <style jsx>{`
        ...
        .pt-tab { background: none; border: none; cursor: pointer; padding: 14px 2px; font-family: 'Inter',sans-serif; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; color: #6B7280; white-space: nowrap; border-bottom: 2px solid transparent; transition: color .15s, border-color .15s; }
