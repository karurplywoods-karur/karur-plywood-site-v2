  ...
  return (
    <div style={{ background: '#FAF8F5', paddingTop: 58, minHeight: '100vh' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '24px 48px 60px' }} className="off-pad">
        ...
        <h1 style={{ fontFamily: "'Inter',sans-serif", fontSize: 'clamp(1.6rem,3vw,2.1rem)', fontWeight: 700, color: '#0B2447', margin: '0 0 6px' }}>Offers & Deals</h1>
        ...
        {coupons.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '70px 0', background: '#FFFFFF', border: '1px solid #E5E1DC', borderRadius: 12 }}>
            ...
            <div style={{ fontFamily: "'Inter',sans-serif", fontWeight: 700, color: '#0B2447', marginBottom: 8, fontSize: 17 }}>No active offers right now</div>
          ...
          <div className="off-grid">
            {coupons.map((c: any) => (
              <div key={c.id} className="off-card">
                ...
                <div style={{ fontFamily: "'Inter',sans-serif", fontWeight: 800, fontSize: 20, color: '#0B2447', letterSpacing: '.04em', marginBottom: 6 }}>{c.code}</div>
      ...
      <style>{`
        ...
        .off-card-badge { display: inline-block; background: #F07316; color: #FFFFFF; font-family: 'Inter',sans-serif; font-weight: 700; font-size: 11px; letter-spacing: .04em; padding: 4px 12px; border-radius: 20px; margin-bottom: 12px; }
        .off-shop-btn { display: inline-flex; margin-top: 14px; padding: 9px 18px; background: #0B2447; color: #FFFFFF; border-radius: 6px; font-family: 'Inter',sans-serif; font-weight: 700; font-size: 12px; text-decoration: none; }
        .off-btn-wa { display: inline-flex; align-items: center; padding: 11px 22px; background: #f0fdf4; border: 1px solid #bbf7d0; color: #16a34a; border-radius: 6px; font-family: 'Inter',sans-serif; font-weight: 700; font-size: 13px; text-decoration: none; }
